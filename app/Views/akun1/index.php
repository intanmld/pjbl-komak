...
<section class="section">
    <div class="section-header">
        <a href="<?= site_url('akun1/new') ?>" class="btn btn-primary">Add Akun</a>
    </div>
                            ...
                            <?php foreach ($dtakun1 as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 60%;">
                                        ...
                                        <a href="<?= site_url('akun1/delete/' . $value->id_akun1) ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Akun Ini?');" class="btn btn-danger"><i class="fas fa-trash"></i>Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
